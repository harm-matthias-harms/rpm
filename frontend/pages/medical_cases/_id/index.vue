        ...
        <v-card>
          <v-card-text>
            <h4 class="display-1 font-weight-light mb-2 black--text">
              {{ medicalCase.title }}
              <v-icon v-if="!medicalCase.approved" color="green" @click="approve(medicalCase)">check</v-icon>
              <v-icon color="primary" @click="editMedicalCase(medicalCase)">edit</v-icon>
              <DeleteButton
              ...
              <v-expansion-panel-content>
                <v-list dense>
                  <v-list-item v-if="medicalCase.general.discipline">
                    ...
                    <v-list-item-content class="align-end">{{ medicalCase.general.discipline }}</v-list-item-content>
                  </v-list-item>
                  <v-list-item v-if="medicalCase.general.context">
                    <v-list-item-content>Context:</v-list-item-content>
                    <v-list-item-content
                      class="align-end"
                    >{{ medicalCase.general.context.join(', ') }}</v-list-item-content>
                  </v-list-item>
                  <v-list-item v-if="medicalCase.general.scenario">
                    <v-list-item-content>Scenario:</v-list-item-content>
                    <v-list-item-content
                      class="align-end"
                    >{{ medicalCase.general.scenario.join(', ') }}</v-list-item-content>
                  </v-list-item>
                </v-list>
              </v-expansion-panel-content>
            </v-expansion-panel>
              ...
              <v-expansion-panel-content>
                <v-list dense>
                  <v-list-item v-if="medicalCase.patient.type">
                    ...
                    <v-list-item-content class="align-end">{{medicalCase.patient.type}}</v-list-item-content>
                  </v-list-item>
                  <v-list-item v-if="medicalCase.patient.triage">
                    <v-list-item-content>Triage:</v-list-item-content>
                    <v-list-item-content class="align-end">{{medicalCase.patient.triage}}</v-list-item-content>
                  </v-list-item>
                  <v-list-item v-if="medicalCase.patient.gender">
                    <v-list-item-content>Gender:</v-list-item-content>
                    <v-list-item-content class="align-end">{{medicalCase.patient.gender.join(', ')}}</v-list-item-content>
                  </v-list-item>
                  <v-list-item v-if="medicalCase.patient.age">
                    <v-list-item-content>Age:</v-list-item-content>
                    <v-list-item-content class="align-end">{{medicalCase.patient.age}}</v-list-item-content>
                  </v-list-item>
                </v-list>
              </v-expansion-panel-content>
            </v-expansion-panel>
              ...
              <v-expansion-panel-content>
                <v-list dense>
                  <v-list-item v-if="medicalCase.medical.signs">
                    ...
                    <v-list-item-content class="align-end">{{ medicalCase.medical.signs }}</v-list-item-content>
                  </v-list-item>
                  <v-list-item v-if="medicalCase.medical.allergies">
                    <v-list-item-content>A - Allergies:</v-list-item-content>
                    <v-list-item-content class="align-end">{{ medicalCase.medical.allergies }}</v-list-item-content>
                  </v-list-item>
                  <v-list-item v-if="medicalCase.medical.medication">
                    <v-list-item-content>M - Medications:</v-list-item-content>
                    <v-list-item-content class="align-end">{{ medicalCase.medical.medication }}</v-list-item-content>
                  </v-list-item>
                  <v-list-item v-if="medicalCase.medical.past">
                    <v-list-item-content>P - Past pertinent medical history:</v-list-item-content>
                    <v-list-item-content class="align-end">{{ medicalCase.medical.past }}</v-list-item-content>
                  </v-list-item>
                  <v-list-item v-if="medicalCase.medical.loi">
                    <v-list-item-content>L - Last oral intake:</v-list-item-content>
                    <v-list-item-content class="align-end">{{ medicalCase.medical.loi }}</v-list-item-content>
                  </v-list-item>
                  <v-list-item v-if="medicalCase.medical.events">
                    <v-list-item-content>E - Events leading up to present illness/injury:</v-list-item-content>
                    <v-list-item-content class="align-end">{{ medicalCase.medical.events }}</v-list-item-content>
                  </v-list-item>
                </v-list>
              </v-expansion-panel-content>
            </v-expansion-panel>
              ...
              <v-expansion-panel-content>
                <v-list dense>
                  <v-list-item v-if="medicalCase.makeup.makeup">
                    <v-list-item-content>Make-up intructions:</v-list-item-content>
                    <v-list-item-content class="align-end">{{ medicalCase.makeup.makeup}}</v-list-item-content>
                  </v-list-item>
                  <v-list-item v-if="medicalCase.makeup.acting">
                    <v-list-item-content>Acting instructions:</v-list-item-content>
                    <v-list-item-content
                      class="align-end"
                    >{{ medicalCase.makeup.acting }}</v-list-item-content>
                  </v-list-item>
                </v-list>
              </v-expansion-panel-content>
            </v-expansion-panel>
            ...
            <v-col v-for="(file, i) in medicalCase.files" :key="i" sm="12" md="4" lg="3">
              <v-card>
                ...
                <v-card-actions
                  v-if="!medicalCase.author.username || medicalCase.author.id == $store.state.user.user.id"
                >
                  <v-btn text color="red" @click="$set(deleteFileDialog, i, true)">Delete</v-btn>
                  <Confirm
